...
//    }
@PostMapping("/addReviewReport")
public ResponseEntity<ReviewReport> createReviewReport(@RequestBody ReviewReportRequest request) {
    ReviewReport createdReport = reviewReportServices.createReviewReport(request);
